...
public partial class Admin_Tourist_Guider_Booking : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                dt = Tourist_Guider_Booking_Search(0, 0,0, "", "");
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        if (_Id == 0)
        {
            ...
            if (x == true)
            {
                ...
                Tourist_Guider_Booking_Search(0, 0,0, "", "");
                ClearControls();
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        ...
        Tourist_Guider_Booking_Search(0, _Guider_Places_Id, _Tourist_Id, txt_Date_Time.Text, txt_Notes.Text);
    ...
    protected void gvTourist_Guider_Booking_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                int id = int.Parse(e.CommandArgument.ToString());
                Tourist_Guider_Booking_Search(id, 0,0, "", "");
            }
        }
        catch (Exception ex)
        {
