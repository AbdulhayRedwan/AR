<%@ Page Title="" Language="C#" MasterPageFile="~/Event_Manager/MasterEvent_Manager.master" AutoEventWireup="true" CodeFile="Manage_My_Events.aspx.cs" Inherits="Event_Manager_Manage_My_Events" %>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Manage My Events</h3>
                </div>
                 ...
                 <div class="content-header-right col-md-8 col-12">
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="Manage_My_Events.aspx">Home</a>
                                </li>
                            ...
                            <div class="card-content">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <table width="90%" class="table table-borderless mb-0">
                                            ...
                                            <tr>
                                                <td> <asp:Label ID="lbl_Name_H" runat="server" Text="Event Name"></asp:Label></td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                     <asp:TextBox ID="txt_Description" runat="server" MaxLength="4000"  Width="90%" class="form-control" Height="120px" TextMode="MultiLine"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td> <asp:Label ID="lbl_Date_Times_H" runat="server" Text="Date Times"></asp:Label></td>
                                                <td>
                                                    <asp:TextBox ID="txt_Date_Times" runat="server" MaxLength="550"  Width="90%" class="form-control" TextMode="DateTimeLocal"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RFV_Date_Times" runat="server" ControlToValidate="txt_Date_Times" ValidationGroup="f" CssClass="failureNotification">*</asp:RequiredFieldValidator></td>
                                            </tr>
                                            <tr>
                                                <td> <asp:Label ID="lbl_Conditions_H" runat="server" Text="Conditions"></asp:Label></td>
                                                <td>
                                                    <asp:TextBox ID="txt_Conditions" runat="server" MaxLength="1000"  Width="90%" class="form-control" Height="120px" TextMode="MultiLine"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td> <asp:Label ID="lbl_Tickit_Price_H" runat="server" Text="Tickits Prices"></asp:Label></td>
                                                <td>
                                                    <asp:TextBox ID="txt_Tickit_Price" runat="server" MaxLength="550"  Width="90%" class="form-control"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RFV_Tickit_Price" runat="server" ControlToValidate="txt_Tickit_Price" ValidationGroup="f" CssClass="failureNotification">*</asp:RequiredFieldValidator></td>
                                            </tr> 
                                              <tr>
                                                <td>
                                                     <asp:Label ID="lbl_Img1_H" runat="server" Text="Img1"></asp:Label>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="gvEvents" OnRowCommand="gvEvents_RowCommand" runat="server" AutoGenerateColumns="False" Width="95%" OnPageIndexChanging="gvEvents_PageIndexChanging" AllowPaging="True" CellPadding="4" PageSize="15" CssClass="table" ForeColor="#333333" GridLines="Both">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Date_Times" SortExpression="Date_Times">
                                                <ItemTemplate> <asp:Label ID="lbl_Date_Times" runat="server" Text='<%# Bind("Date_Times") %>'></asp:Label>
                                                    <headerstyle horizontalalign="Left" />
                                                    <itemstyle horizontalalign="Left" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Conditions" SortExpression="Conditions">
                                                <ItemTemplate> <asp:Label ID="lbl_Conditions" runat="server" Text='<%# Bind("Conditions") %>'></asp:Label>
                                                    <headerstyle horizontalalign="Left" />
                                                    <itemstyle horizontalalign="Left" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Tickit_Price" SortExpression="Tickit_Price">
                                                <ItemTemplate> <asp:Label ID="lbl_Tickit_Price" runat="server" Text='<%# Bind("Tickit_Price") %>'></asp:Label>
                                                    <headerstyle horizontalalign="Left" />
                                                    <itemstyle horizontalalign="Left" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
