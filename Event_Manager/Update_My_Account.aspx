<%@ Page Title="" Language="C#" MasterPageFile="~/Event_Manager/MasterEvent_Manager.master" AutoEventWireup="true" CodeFile="Update_My_Account.aspx.cs" Inherits="Event_Manager_Update_My_Account" %>
                ...
                <div class="content-header-right col-md-8 col-12">
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="Event_Manager_Default.aspx">Home</a>
                                </li>
            ...
            <div class="content-body">
                ...
                <section id="global-settings" class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="card-text">
                                <p>It could help for managing the data of   <a href="#" target="_blank">Event Manager.</a></p>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table width="90%" class="table table-borderless mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_Email" runat="server" Width="90%" class="form-control"></asp:TextBox>
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txt_Email" ValidationGroup="f" runat="server" ErrorMessage="*please Enter Correct Email"     ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ></asp:RegularExpressionValidator>
                                        ...
                                        <tr runat="server" visible="false">
                                            <td>
                                                <asp:Label ID="Lab1el1" runat="server" Text="Admin"></asp:Label></td>
                                            <td>
                                                <asp:DropDownList ID="Ddl_Admin_Id" runat="server" class="form-control" AutoPostBack="True"></asp:DropDownList>
                                    ...
                                    <p>
                                        ...
                                        <p dir="ltr">
                                            <asp:Button ID="btn_Save" runat="server" Text="Update Account" OnClick="btn_Save_Click" ValidationGroup="f" class="btn btn-secondary btn-min-width mr-1 mb-1" />
