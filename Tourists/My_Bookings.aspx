<%@ Page Title="" Language="C#" MasterPageFile="~/Tourists/MasterTour.master" AutoEventWireup="true" CodeFile="My_Bookings.aspx.cs" Inherits="Tourists_My_Bookings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                            ...
                            <div class="card-content">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table width="90%">
                                        ...
                                        <tr runat="server" id="cb" visible="false">
                                            <td style="padding-left: 10px;">
 ...
 <asp:TemplateField HeaderText="Guider_Name" SortExpression="Guider_Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblGuider_Name" runat="server" Text='<%# Bind("Guider_Name") %>'></asp:Label>
                                                    <headerstyle horizontalalign="Left" />
                                                    <itemstyle horizontalalign="Left" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
     ...
     <asp:TemplateField HeaderText="Place_Name" SortExpression="Place_Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPlace_Name" runat="server" Text='<%# Bind("Place_Name") %>'></asp:Label>
                                                    <headerstyle horizontalalign="Left" />
                                                    <itemstyle horizontalalign="Left" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Notes" SortExpression="Notes" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Notes" runat="server" Text='<%# Bind("Notes") %>'></asp:Label>
                                                    <headerstyle horizontalalign="Left" />
                                                    <itemstyle horizontalalign="Left" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Edit">
                                                <ItemTemplate>
                                                   <asp:ImageButton ID="imgbtn_Delete" CommandName="Delte" ImageUrl="~/Admin/assets/del.png" Width="30px" runat="server" CommandArgument='<%# Bind("ID") %>' OnClientClick="return validateDelete();" />
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
