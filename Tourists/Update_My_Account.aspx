<%@ Page Title="" Language="C#" MasterPageFile="~/Tourists/MasterTour.master" AutoEventWireup="true" CodeFile="Update_My_Account.aspx.cs" Inherits="Tourists_Update_My_Account" %>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Manage My Account</h3>
                </div>
                <div class="content-header-right col-md-8 col-12">
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="Tour_Services.aspx">Home</a>
                                </li>
                                ...
                                <table width="90%" class="table table-borderless mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RFV_Full_Name" runat="server" ControlToValidate="txt_Full_Name" ValidationGroup="f" CssClass="failureNotification">*</asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RFV_Age" runat="server" ControlToValidate="txt_BOD" ValidationGroup="f" CssClass="failureNotification">*</asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RFV_Email" runat="server" ControlToValidate="txt_Email" ValidationGroup="f" CssClass="failureNotification">*</asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lbl_Resedency_H" runat="server" Text="Resedency"></asp:Label></td>
                                        <td>
                                            <asp:TextBox ID="txt_Resedency" runat="server" MaxLength="50" Width="90%" class="form-control"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RFV_Ttxt_Address" runat="server" ControlToValidate="txt_Resedency" ValidationGroup="f" CssClass="failureNotification">*</asp:RequiredFieldValidator></td>
                                    </tr>
