<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAdmin.master" AutoEventWireup="true" CodeFile="Tourist_Guider_Booking.aspx.cs" Inherits="Admin_Tourist_Guider_Booking" %>
                            ...
                            <div class="card-content">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <p>
                                        ...
                                        <p dir="ltr">
                                            <asp:Button ID="btn_Save" runat="server" Text="Save" OnClick="btn_Save_Click" ValidationGroup="f" class="btn btn-secondary btn-min-width mr-1 mb-1" Visible="False" />
                                    ...
                                    <asp:GridView ID="gvTourist_Guider_Booking" OnRowCommand="gvTourist_Guider_Booking_RowCommand" runat="server" AutoGenerateColumns="False" Width="95%" OnPageIndexChanging="gvTourist_Guider_Booking_PageIndexChanging" AllowPaging="True" CellPadding="4" PageSize="15" CssClass="table" ForeColor="#333333" GridLines="Both">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgbtn_Update" ImageUrl="~/Admin/assets/update.png" runat="server" CommandArgument='<%# Bind("ID") %>' CommandName="updte" Width="30px" />
                                                    <asp:ImageButton ID="imgbtn_Delete" CommandName="Delte" Visible="false" ImageUrl="~/Admin/assets/del.png" Width="30px" runat="server" CommandArgument='<%# Bind("ID") %>' OnClientClick="return validateDelete();" />
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
